...
namespace TechTreeMVCWebApplication.Areas.Admin.Controllers
{
    ...
    public class UsersToCategoryController : Controller
    {
        ...
        {
            UserCategoryListModel usersCategoryListModel = new UserCategoryListModel();
        ...
        public async Task<IActionResult> SaveSelectedUsers([Bind("CategoryId, UsersSelected")] UserCategoryListModel usersCategoryListModel)
        {
        ...
        private async Task<List<UserCategory>> GetUsersForCategoryToAdd(UserCategoryListModel usersCategoryListModel)
        {
